...
if apply_filter:
    folder = "Pavia/Post/CV_" + classifier + "/"
else:
    folder = "Pavia/CV_" + classifier + "2/"
    ...
    for cv_index in range(5):
        ...
        for train_index, test_index in skfold.split(X_reduced, y_reduced):
            ...
            if classifier =="RF":
                ...
                clf = svm.SVC(C=10, gamma=0.25, kernel='rbf')
            elif classifier == "1NN":
            ...
            raw = Pavia_CV_DecoderAux.decode(input, patch_size, clf, feature_selector=model)
