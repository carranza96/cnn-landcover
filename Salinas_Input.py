...
# Global constants describing the Indian Pines data set.
...
class Salinas_Input():
    ...
    def __init__(self):
        ...
        # Load dataset
        self.input_data = scipy.io.loadmat("Data/Salinas_corrected.mat")['salinas_corrected']
        self.target_data = scipy.io.loadmat("Data/Salinas_gt.mat")['salinas_gt']
