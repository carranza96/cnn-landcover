...
class SanFrancisco_Input():

    def __init__(self):

        # Load dataset
        trainingset = envi.open('SanFrancisco/Data/SanFrancisco.hdr',
                                'SanFrancisco/Data/SanFrancisco.raw')

        trainingset_gt = np.array(Image.open('SanFrancisco/Data/Training_Set/cm6406_ground_truth_training.tiff'))
